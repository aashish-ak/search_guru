  ...
  request(options, function (error, response, html) {
    if (!error && response.statusCode == 200) {
      ...
      fac.each(function (i, el) {
        ...
        // console.log(query);
        schema.update(query, iitmandi_fac, {
          upsert: true
        }, function (err) {
          if (err) {
            console.log(err);
  ...
  request(options, function (error, response, html) {
    if (!error && response.statusCode == 200) {
      ...
      fac.each(function (i, el) {
        ...
        schema.update(query, iitb_ee_fac, {
          upsert: true
        }, function (err) {
          if (err) {
            console.log(err);
